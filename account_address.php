...
<body data-model-type="CATEGORY" data-model-id="871" data-model-relative-url="watches.html"
    data-model-redirect-code="0">
            ...
            <header class="page-header">
                <div class="header-toolbar">
                    <div class="center-content">
                        ...
                        <div class="center">
                            <span class="logo">
                                <a href="index.php"><img src="./dist/file/jomashop_logo.7c0762d85d36b44f0c59.png"
                                        alt="logo"></a>
                            </span>
                                                    ...
                                                    <div class="search-input-wrapper">
                                                        ...
                                                        <span class="icon-search">
                                                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                                                ...
                                                                <path d="M14.5352 14.5359L19.2493 19.25" stroke="black"
                                    ...
                                    <ul class="MenuWrapper">
                                        <li class="menu-item level-1 shop-by-brands">
                                            <div class="menu-item-header">
                                                ...
                                                <a class="levelTop" href="" aria-label="Shop By Brand"
                                        ...
                                        <li class="menu-item level-1 watches">
                                            <div class="menu-item-header">
                                                ...
                                                <a class="levelTop" href="" aria-label="Watches"
                                                    tabindex="-1">Watches</a>
                                            </div>
                                            <div class="subCat">
                                                <div class="subCatParent">
                                                    <div class="imageWrapper imageWrapper-1"></div>
                            ...
                            <div class="container">
                                <div class="search">
                                    <div class="search-suggestions">
                                        <div class="search-input-wrapper">
                                            <input type="text" class="search-field-input"
                                                placeholder="Search by brand or model" aria-label="Search box" value="">
                                            <span class="icon-search">
                                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                ...
                                <div class="search">
                                    <div class="search-suggestions">
                                        <div class="search-input-wrapper" tabindex="0">
                                            <input type="text" class="search-field-input "
                                                placeholder="Search by brand or model" aria-label="Search box">
                                            <span class="icon-search">
                                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                ...
                <div class="bottom-promo">
                    <div class="click-handler">
                        <div class="row-contained-EzA header-promo-bottom-wrapper">
                            <div
                                style="border-width: 1px; border-style: none; border-image: initial; border-radius: 0px; margin: 0px; padding: 0px; display: flex; justify-content: flex-start; flex-direction: column;">
                                <div>
                                    <div class="banner">
            ...
            <main class="page" id="maincontent">
                ...
                <div class="myaccount-wrap container-width">
                    <div class="myaccount-wrapper">
                        <div class="my-account-navigation css-0">
                            <strong aria-level="2" role="heading" class="my-account-mob-menu-head">
                                My Account
                                <span class="">+</span>
                            </strong>
                            <nav aria-label="Account Navigation" class="nav-wrapper ">
                                <div class="nav-list">
                                    <h3 class="account-form-title">
                                        <a href="#">Welcome, Tuấn!</a>
                                    </h3>
                                    <div class="account-form-group account-form-sidebar">
                                        <h4 class="group-title">Overview</h4>
                                        <a aria-current="page" class="group-item group-overview active"
                                            href="/my-account">
                                            ...
                                            <span class="group-item-name">Overview</span>
                                        ...
                                        <a class="group-item group-item-card" href="/my-account/my-payment-data">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                                                height="24">
                                                <path
                                        ...
                                        <a class="group-item group-item-card" href="/my-account/gift-and-credits">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                                                height="24">
                                                <path
                                        ...
                                        <a class="group-item" href="/my-account/account-information">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                                                height="24">
                                                <path
                                        ...
                                        <a class="group-item item-active active" href="/my-account/address" aria-current="page">
                                            ...
                                            <span class="group-item-name">My Addresses</span>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round" class="icon-right">
                                                <line x1="5" y1="12" x2="19" y2="12"></line>
                                        ...
                                        <button class="btn-new-design secondary btn-sign-out">Sign Out</button>
                                    </div>
                                </div>
                            </nav>
                        </div>
                                    ...
                                    <div class="new-address-form">
                                        <form>
                                            <div class="contact-inform-group">
                                                <div class="field-wrapper  can-focus  "><label for="firstname"
                                                        class="label">First Name<span
                                                            class="requiredSymbol">*</span></label>
                                                    <div class="field-icons" style="--iconsBefore: 0; --iconsAfter: 0;">
                                                        <span class="input-block"><input class="input-box-new-design"
                                                                field="firstname" type="text" id="firstname"
                                                                autocomplete="given-name" placeholder="First Name"
                                                                value="Tuấn"></span><span class="before"></span><span
                                                            class="after"></span>
                                                    </div><span class="message-root">
                                                        <p class="root"></p>
                                                    </span>
                                                </div>
                                                <div class="field-wrapper  can-focus  "><label for="lastname"
                                                        class="label">Last Name<span
                                                            class="requiredSymbol">*</span></label>
                                                    <div class="field-icons" style="--iconsBefore: 0; --iconsAfter: 0;">
                                                        <span class="input-block"><input class="input-box-new-design"
                                                                field="lastname" type="text" id="lastname"
                                                                autocomplete="last-name" placeholder="Last Name"
                                                                value="Nguyễn Dương Anh"></span><span
                                                            class="before"></span><span class="after"></span>
                                                    </div><span class="message-root">
                                                        <p class="root"></p>
                                                    </span>
                                                </div>
                                            </div>
                                            <div class="field-wrapper  can-focus  "><label for="company"
                                                    class="label">Company</label>
                                                <div class="field-icons" style="--iconsBefore: 0; --iconsAfter: 0;">
                                                    <span class="input-block"><input class="input-box-new-design"
                                                            field="company" type="text" id="company"
                                                            autocomplete="company-name" placeholder="Company"
                                                            value=""></span><span class="before"></span><span
                                                        class="after"></span>
                                                </div><span class="message-root">
                                                    <p class="root"></p>
                                                </span>
                                            </div>
                                            <div class="field-wrapper  can-focus  "><label for="telephone"
                                                    class="label">Phone Number<span
                                                        class="requiredSymbol">*</span></label>
                                                <div class="field-icons" style="--iconsBefore: 0; --iconsAfter: 0;">
                                                    <span class="input-block"><input class="input-box-new-design"
                                                            field="telephone" type="text" id="telephone"
                                                            autocomplete="telephone-name" placeholder="Phone Number"
                                                            value=""></span><span class="before"></span><span
                                                        class="after"></span>
                                                </div><span class="message-root">
                                                    <p class="root"></p>
                                            ...
                                            <div class="field-wrapper  can-focus  ">
                                                ...
                                                <div class="select-box-wrapper">
                                                    <div class="dropdown-new-design input-select">
                                                        ...
                                                        <button type="button" class="dropdown-toggle expanded">United States</button>
                                                        <div class="add_section dropdown-menu">
                                                            ...
                                                            <div class="dropdown-item">Bosnia &amp; Herzegovina</div>
                                                            <div class="dropdown-item">Botswana</div>
                                                            <div class="dropdown-item">Brunei</div>
                                                            ...
                                                            <div class="dropdown-item">Croatia</div>
                                                            ...
                                                            <div class="dropdown-item">Hong Kong SAR China</div>
                                                            ...
                                                            <div class="dropdown-item">Macao SAR China</div>
                                                            ...
                                                            <div class="dropdown-item">Myanmar (Burma)</div>
                                                            ...
                                                            <div class="dropdown-item">Réunion</div>
                                                            ...
                                                            <div class="dropdown-item">Taiwan, Province of China</div>
                                                            <div class="dropdown-item">Tanzania</div>
                                                            <div class="dropdown-item">Thailand</div>
                                                            <div class="dropdown-item">Trinidad &amp; Tobago</div>
                                                            ...
                                                            <div class="dropdown-item">Åland Islands</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="field-wrapper  can-focus  "><label for="street[0]"
                                                    class="label">Street Address<span
                                                        class="requiredSymbol">*</span></label>
                                                <div class="field-icons" style="--iconsBefore: 0; --iconsAfter: 0;">
                                                    <span class="input-block"><input class="input-box-new-design"
                                                            field="street[0]" type="text" id="street[0]"
                                                            autocomplete="street-name" placeholder="Street Address"
                                                            value=""></span><span class="before"></span><span
                                                        class="after"></span>
                                                </div><span class="message-root">
                                                    <p class="root"></p>
                                            ...
                                            <div class="contact-inform-group">
                                                <div class="field-wrapper  can-focus  "><label for="city"
                                                        class="label">City<span class="requiredSymbol">*</span></label>
                                                    <div class="field-icons" style="--iconsBefore: 0; --iconsAfter: 0;">
                                                        <span class="input-block"><input class="input-box-new-design"
                                                                field="city" type="text" id="city"
                                                                autocomplete="city-name" placeholder="City"
                                                                value=""></span><span class="before"></span><span
                                                            class="after"></span>
                                                    </div><span class="message-root">
                                                        <p class="root"></p>
                                                ...
                                                <div class="field-wrapper  can-focus  "><label for="region"
                                                        class="label">State/Province<span
                                                            class="requiredSymbol">*</span></label>
                                                    <div class="select-box-wrapper">
                                                        <div class="dropdown-new-design input-select"><span
                                                                class="dropdown-label"></span><button type="button"
                                                                class="dropdown-toggle">Select State/Province</button>
                                                        </div>
                                                    </div><span class="message-root">
                                                        <p class="root"></p>
                                                    </span>
                                                </div>
                                                <div class="field-wrapper  can-focus  "><label for="postcode"
                                                        class="label">Zip/Postal Code<span
                                                            class="requiredSymbol">*</span></label>
                                                    <div class="field-icons" style="--iconsBefore: 0; --iconsAfter: 0;">
                                                        <span class="input-block"><input class="input-box-new-design"
                                                                field="postcode" type="text" id="postcode"
                                                                autocomplete="postcode-name"
                                                                placeholder="Zip/Postal Code" value=""></span><span
                                                            class="before"></span><span class="after"></span>
                                                    </div><span class="message-root">
                                                        <p class="root"></p>
                                                    </span>
                                            ...
                                            <div class="submit-btn-form"><button class="btn-new-design primary"
                            ...
                            <div class="footer-inner-content container-width">
                                <div class="footer-top">
                                    <div class="logo-footer">
                                        ...
                                        <p class="description-footer description-opacity">Your Online Shopping for
                                            Watches, Handbags and More.</p>
                                    </div>
                                    <div class="footer-social-links">
                                        <div class="social-new-design">
                                            <a href="https://www.facebook.com/JomaShop" target="_blank"
                                                class="social-item" rel="noreferrer">
                                            ...
                                            <a href="https://twitter.com/Jomashop" target="_blank" class="social-item"
                                                rel="noreferrer">
                                            ...
                                            <a href="https://www.instagram.com/jomashop/" target="_blank"
                                                class="social-item" rel="noreferrer">
                                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <a href="https://www.tiktok.com/@jomashop" target="_blank"
                                                class="social-item" rel="noreferrer">
                                                <svg fill="#ffffff" width="15" height="15" viewBox="0 0 24 24"
                                                    role="img" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff">
                                                    <g stroke-width="0"></g>
                                            ...
                                            <a href="https://www.youtube.com/@jomashop" target="_blank"
                                                class="social-item" rel="noreferrer">
                                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="styled-subscription-wrapper ">
                                        ...
                                        <form id="newsLetterForm" novalidate="">
                                            <input type="hidden" name="crvs"
                                                value="gmOC6zTLL27NnfmNCVsSNn0QPJVmQGgJxEaNaandxymy_GqwvytQg7O3XE7dHn9ddMQdgK7-8jH3ZZ5AqMcZD422V8YcpJ4TTYFARIPJOZbcYjlDSKwxh0ROoYriww143AsH7IIbByY1YklU0W_szjYvBzo78w2tPGs6JZe3Voknsd0s8C4KpvmmTv3peNuF0TiPEbrBIQ8WF-2-TXHogTKaxLYSX2rSGdRj-dWXHkE">
                                            ...
                                            <div class="field-wrapper  can-focus  ">
                                                ...
                                                <div class="field-icons" style="--iconsBefore: 0; --iconsAfter: 0;">
                                                    <span class="input-block">
                                                        <input type="email" placeholder="Enter your email" class=""
                                                            id="newsLetterEmail" name="email" value="">
                                                    </span>
                                                ...
                                                <button class="btn-new-design primary btn" id="newsLetterSubmit"
                                                    type="submit">Subscribe</button>
                                                <span id="newsLetterError" class="root_error message-root">Please enter
                                                    a valid email</span>
                                            </div>
                                            <span class="description-subscribing">By subscribing you agree with our
                                                <a href="https://www.iubenda.com/privacy-policy/848793"
                                ...
                                <div class="accordion-item col-4 customer-service opened">
                                    ...
                                    <div class="accordion-content contain-non-links collapse show">
                                        <div>
                                            ...
                                            <li>
                                                <address>Brooklyn Army Terminal Building A <br>140A 58th Street, Suite
                                                    6N - 6th
                ...
                <div id="Footer_Mobile">
                    <div class="footer-top">
                        <div class="logo-footer">
                            <img src="./dist/file/footer_logo.f00d90d3496073687709.png" alt="Logo Foolter">
                            <p class="description-footer">— Since 1999</p>
                            <p class="description-footer description-opacity">Your Online Shopping for Watches, Handbags
                                and More.</p>
                        </div>
                        <div class="footer-social-links">
                            <div class="social-new-design">
                                <a href="https://www.facebook.com/JomaShop" target="_blank" class="social-item"
                                    rel="noreferrer">
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_2510_108117)">
                                ...
                                <a href="https://www.instagram.com/jomashop/" target="_blank" class="social-item"
                                    rel="noreferrer">
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_2510_108127)">
                                ...
                                <a href="https://www.tiktok.com/@jomashop" target="_blank" class="social-item"
                                    rel="noreferrer">
                                    <svg fill="#ffffff" width="15" height="15" viewBox="0 0 24 24" role="img"
                                ...
                                <a href="https://www.youtube.com/@jomashop" target="_blank" class="social-item"
                                    rel="noreferrer">
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_2510_108135)">
                        ...
                        <div class="footer-links-wrapper container-width">
                            <div class="chat-call-section" tabindex="0">
                                ...
                                <ul class="chat-call-dropdown">
                                    <li>
                                        <a href="tel://1-877-834-1434" data-href="tel://1-877-834-1434"
                                            title="Tap here to call us!">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                            ...
                            <ul class="item-sub-cat">
                                <div class="accordion-item col-0 contact-us opened">
                                    ...
                                    <div class="accordion-content collapse show">
                                        <li><a class="" href="">Customer Service</a></li>
                                        <li><a class="" href="">Order Status</a></li>
                                        <li><a class="/email-preference-footer" href="">Update Your Email
                                                Preferences</a></li>
                                        <li><a class="" href="">Trade-In Your Watch</a> </li>
                                        <li><a class="" href="">Sell my Rolex</a></li>
                                        <li><a class="" href="">Sell my Watch</a></li>
                                ...
                                <div class="accordion-item col-2 help-center opened">
                                    ...
                                    <div class="accordion-content collapse show">
                                        ...
                                        <li><a href="https://jomashop.zendesk.com/hc/en-us/articles/11923107626907-Shipping-Options-Policies/"
                                                class="">Shipping Options</a></li>
                                        <li><a href="https://jomashop.zendesk.com/hc/en-us/articles/11923118455835-Do-you-ship-internationally-/"
                                                class="">International Shipping</a></li>
                                        <li><a href="https://jomashop.zendesk.com/hc/en-us/articles/11923107419419-Which-payment-methods-do-you-accept-/"
                                                class="">Payment Options</a></li>
                                        <li><a class="" href="/pay-with-bitcoin-ethereum-dogecoin-sale.html">Pay with
                                                Bitpay / Crypto</a>
                                        </li>
                                    </div>
                                </div>
                                <div class="accordion-item col-3 returns-&amp;-warranty opened">
                                    ...
                                    <div class="accordion-content collapse show">
                                        ...
                                        <li><a href="//help.jomashop.com/articles/31751-start-a-return-returns-center/"
                                                class="">Returns
                                                Center</a></li>
                                        <li><a href="https://jomashop.zendesk.com/hc/en-us/articles/11923055034139-Do-you-give-a-warranty-with-the-watch-/"
                                                class="">Warranty Policy</a></li>
                                        <li><a href="//help.jomashop.com/articles/5578-request-a-repair/"
                                                class="">Warranty Repair
                                                Center</a></li>
                                    </div>
                                </div>
                                <div class="accordion-item col-4 customer-service opened">
                                    ...
                                    <div class="accordion-content contain-non-links collapse show">
                                        <div>
                                            ...
                                            <li>
                                                <address>Brooklyn Army Terminal Building A <br>140A 58th Street, Suite
                                                    6N - 6th Floor<br>Brooklyn, NY 11220
                                                </address>
                                            </li>
                                        </div>
                                        <div class="chat-call-section" tabindex="0">
                                            ...
                                            <ul class="chat-call-dropdown">
                                                <li><a href="tel://1-877-834-1434" data-href="tel://1-877-834-1434"
                                                        title="Tap here to call us!"><svg width="24" height="24"
                                                ...
                                                <li><a href="#" title="Tap here to Live Chat"><svg width="24"
                                                ...
                                                <li class="whatsapp-item"><a
                                                        ...
                                                        title="Tap here to Live Chat" target="_blank"
                                                        rel="noreferrer"><svg width="24" height="24" viewBox="0 0 24 24"
