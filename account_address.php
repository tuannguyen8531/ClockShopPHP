...
<?php 
    ...
    session_start();
    $_SESSION['customer'] = 'ngoctuyet@gmail.com';
...
<body id="body">
                            ...
                            <nav aria-label="Account Navigation" class="nav-wrapper ">
                                <div class="nav-list">
                                    ...
                                    <div class="account-form-group account-form-sidebar">
                                        ...
                                        <a aria-current="page" class="group-item group-overview active" href="/my-account">
                                        ...
                                        <form method="post">
                                            <button class="btn-new-design secondary btn-sign-out" type="submit" name="signout">Sign Out</button>
                                        </form>
                                    </div>
                                </div>
                            </nav>
    ...
    <script>
        var buttonCountry = document.querySelectorAll(".expanded");
        var list = document.querySelectorAll(".add_section");
        console.log(list);

        for (var i = 0; i < buttonCountry.length; i++) {
            let div = list[i];
            buttonCountry[i].onclick = function(e) {
                div.classList.toggle("show");
            };
        }

        var listCountry = document.querySelectorAll(".dropdown-item");
        listCountry.forEach(function(country) {
            country.addEventListener('click', function() {
                var value = country.innerHTML;
                buttonCountry[0].value = value;
                list[0].classList.remove('show');
            });
        });

        var country = document.getElementById("countryButton").innerHTML;
        var xhr = new XMLHttpRequest();
        xhr.open("GET", "account_address.php", true);
