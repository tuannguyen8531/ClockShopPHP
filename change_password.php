                            ...
                            <nav aria-label="Account Navigation" class="nav-wrapper ">
                                <div class="nav-list">
                                    ...
                                    <div class="account-form-group account-form-sidebar">
                                        ...
                                        <a aria-current="page" class="group-item group-overview" href="/my-account">
                                        ...
                                        <a class="group-item item-active active" href="/my-account/account-information" aria-current="page">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                                        ...
                                        <a class="group-item" href="/my-account/address">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                            ...
                            <div>
                                ...
                                <form class="account-information ">
                                        ...
                                        <div class="field-wrapper  can-focus  "><label for="firstname"
                                            ...
                                            <div class="input-wrapper">
                                                <div class="field-icons" style="--iconsBefore: 0; --iconsAfter: 0;">
                                                    ...
                                                    href="/my-account/account-information/edit"><svg
                                    ...
                                    <div class="field-wrapper  can-focus  "><label for="Password"
                                        ...
                                        <div class="input-wrapper">
                                            <div class="field-icons" style="--iconsBefore: 0; --iconsAfter: 0;"><span
                                                ...
                                                href="/my-account/account-information/password"><svg
                                        ...
                                        <div class="input-wrapper">
                                            <div class="field-icons" style="--iconsBefore: 0; --iconsAfter: 0;"><span
                                                    class="input-block"><input class="input-box-new-design"
                                                        ...
                                                        value="tuan.nda.62cntt@ntu.edu.vn"></span><span
                                                    class="before"></span><span class="after"></span></div><span
                                                class="message-root">
                                                <p class="root"></p>
                                            </span><a title="Change Email" class="link-input"
                                                href="/my-account/account-information/email"><svg
                                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                                                    height="24">
                                                    <path
                                                        d="M5 18.89H6.41421L15.7279 9.57629L14.3137 8.16207L5 17.4758V18.89ZM21 20.89H3V16.6474L16.435 3.21233C16.8256 2.8218 17.4587 2.8218 17.8492 3.21233L20.6777 6.04075C21.0682 6.43128 21.0682 7.06444 20.6777 7.45497L9.24264 18.89H21V20.89ZM15.7279 6.74786L17.1421 8.16207L18.5563 6.74786L17.1421 5.33365L15.7279 6.74786Z">
                                    ...
                                    <div class="account-actions">
                                        <button class="btn-new-design primary" type="submit">Save Changes</button>
                                    </div>
                                </form>
                            </div>
                        </div>
