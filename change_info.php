...
<?php
    ...
    if (isset($_POST['save'])) {
        ...
        if ($isValid) {
            $sqlEditInfo = 'UPDATE customers SET cusFirstName = ?, cusLastName = ? WHERE cusEmail = ?';
            $stmt = $conn->prepare($sqlEditInfo);
            $stmt->bind_param('sss', $firstname, $lastname, $_SESSION['customer']);
            $stmt->execute();
            header('refresh: 0');
        }
    }
                    ...
                    <div class="myaccount-wrapper">
                        ...
                        <div class="myaccount-content">
                            <div>
                                ...
                                <h1 class="my-account__page-title">Change contact</h1>
                                <form class="account-information " method="post">
                                    <div class="change-data-form">
                                        <div class="field-wrapper  can-focus  "><label for="firstname" class="label">First Name<span class="requiredSymbol">*</span></label>
                                            <div class="field-icons" style="--iconsBefore: 0; --iconsAfter: 0;"><span class="input-block"><input class="input-box-new-design" field="firstname" type="text" name="firstname" value="<?= $customer['cusFirstName'] ?>"></span><span class="before"></span><span class="after"></span></div><span class="message-root">
                                                <p class="root_error"><?= !isset($msgFirsttName) ? '' : $msgFirsttName  ?></p>
                                            </span>
                                        </div>
                                        <div class="field-wrapper  can-focus  "><label for="lastname" class="label">Last Name<span class="requiredSymbol">*</span></label>
                                            <div class="field-icons" style="--iconsBefore: 0; --iconsAfter: 0;"><span class="input-block"><input class="input-box-new-design" field="lastname" type="text" name="lastname" value="<?= $customer['cusLastName'] ?>"></span><span class="before"></span><span class="after"></span></div><span class="message-root">
