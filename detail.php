            ...
            <div class="multi-slide-wrapper ">
                <div class="multi-slideout-container">
                    <div class="multi-slideout-header">
                        ...
                        <button class="btn-close"><svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="image-main-container">
                                        <div class="image-main">
                                            <div class="image-main__gallery">
                                                ...
                                                <div class="slide-item">
                                                    <img src="https://cdn2.jomashop.com/media/catalog/product/cache/fde19e4197824625333be074956e7640/h/a/hamilton-khaki-field-king-automatic-silver-dial-mens-watch-h64455523_4.jpg?width=546&amp;height=546" alt="Hamilton Khaki Automatic Men's Watch H64455523 - 546x546 Image #4" aria-describedby="product-description-guarantee" width="546" height="546" title="Hamilton Khaki Automatic Men's Watch H64455523" class="slide-item-main-image">
                                                </div>
                                            ...
                                            <div class="thumbs-wrapper slide-width simple-slider-vertical">
                                                ...
                                                <div class="thumbs-items-wrapper simple-slider-wrapper">
                                                    ...
                                                    <div class="thumb-item simple-slider-slide">
                                                        <a href="#" aria-label="View Image 4">
                                                            <img loading="lazy" alt="Hamilton Khaki Automatic Men's Watch H64455523 - 70x70" src="https://cdn2.jomashop.com/media/catalog/product/cache/65076e0eec254d6ea41c2ba023b4122a/h/a/hamilton-khaki-field-king-automatic-silver-dial-mens-watch-h64455523_4.jpg?width=80&amp;height=80" class="image-wrapper" longdesc="#product-description-guarantee">
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="pdp-heading-wrapper">
                                    <h1 class="brand-name-container">
                                        <a href="/hamilton.html">
                                            <span class="brand-name" data-promo="Holiday Early Bird Sale">Hamilton </span></a><span class="product-name-container"><span id="product-h1-product-name" class="product-name">Khaki Automatic Men's Watch  </span>
                                            <span class="product-info-stock-sku">Item No. H64455523</span></span></h1>
                                            <div class="product-info-block"><div class="product-info-rating">
                                                <div class="pdp-review-stars"><div class="yotpo yotpo-from-product">
                                    ...
                                    <div class="tag-wrapper"><span class="tag-new-design stock-label">IN STOCK</span><span class="tag-new-design discount-label">34% Off</span>
                                </div>
                                </div>
                                <div class="box-to-cart">
                                    <div class="product-info-price">
                                        <div class="price-wrapper ">
                                            ...
                                            <div class="now-price"><span>$459.00</span><span class="spacer"></span><p class="affirm-as-low-as" data-page-type="product" data-amount="45900">As low as <span class="affirm-ala-price">$42</span><span class="month">/mo</span> with <span class="__affirm-logo __affirm-logo-blue __ligature__affirm_full_logo__ __processed">Affirm</span>. <a class="affirm-modal-trigger" aria-label="Learn more about Affirm Financing (opens in modal)" href="javascript:void(0)">Prequalify now</a></p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="description-guarantee" id="product-description-guarantee">
                                <div class="dg-wrap">
                                    <div class="guarantee-list">
                                        <div class="g-items">
                                        <div data-content-type="text" data-appearance="default" data-element="main" data-pb-style="A1M70AS"><div class="authenticity-guaranteed">
                                            <div>
                                                <div>
                                        ...
                                        <div class="product-desc show-more-content">
                                                    ...
                                                    <div class="more-detail-body">
                                                        ...
                                                        <div class="more-detail-Row">
                                                            ...
                                                            <div class="more-detail-content">
                                                                ...
                                                                <span class="more-value">50 meters / 165 feet</span></div>
                                                                <div class="more-detail-content">
                                            ...
                                            <button class="show-text" wz_dt_ref="true" id="showText" onclick="window.location.href='#des'">
                                                <span class="show-more"><span id="textShowMore">Show more</span><svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 21 21" fill="none"><path d="M10.4982 11.5249L14.8292 7.19385L16.0667 8.43128L10.4982 13.9998L4.92969 8.43128L6.16713 7.19385L10.4982 11.5249Z" fill="currentColor"></path>
                                            </svg>
                                        </span>
                                    </button>
                                        </div>
                                        <div class="not-pre-owned g-items">
                                            <div data-content-type="text" data-appearance="default" data-element="main" data-pb-style="IA4JJX5"><div>
                                        ...
                                        <div class="g-items">
                                            <div data-content-type="text" data-appearance="default" data-element="main" data-pb-style="KEU3NAO">
                                                <div><strong>USA Shipping</strong></div><p>All of our items ship from the United States. <a class="view-links" data-guarantee-type="shipping" tabindex="0" href="https://help.jomashop.com/articles/4699-shipping-options-policies" target="_blank" rel="noopener">Learn more</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="arrow-carousal-new-design arrow-next"></div>
                                <div class="slider-list-wrapper slider-grid-wrapper">
                                    ...
                                    <div class="product-content productItem">
                                        ...
                                        <a class="product-image" href="/hamilton-mens-watch-h64455533.html">
                                            <img loading="lazy" alt="Hamilton Khaki King Series Automatic Men's Watch H64455533" src="https://cdn2.jomashop.com/media/catalog/product/cache/df24c858758eb768757877f23cd17493/h/a/hamilton-khaki-king-series-automatic-mens-watch-h64455533.jpg" title="Hamilton Khaki King Series Automatic Men's Watch H64455533" width="250" height="250" class="product-img">
                                        </a>
                                        <a class="product-name" href="/hamilton-mens-watch-h64455533.html">
                                            <span class="brand-name">Hamilton</span><span title="Khaki King Series Automatic Men's Watch H64455533" class="productName-link">Khaki King Series Automatic Men's Watch H64455533</span>
                                        </a>
                                        <div class="tag-wrapper"><span class="tag-new-design discount-label">33% Off</span></div>
                                            <div class="price-wrapper trending">
                                                <div class="was-price-wrapper">
                                                    <div class="was-wrapper"><span>$695.00</span></div>
                                            </div>
                                                <div class="now-price"><span>$469.00</span></div>
                                        </div>
                                    </div>
                                    <div class="product-content productItem">
                                        <button class="wishlist-icon-new-design">
                        ...
                        <div class="footer-links-wrapper container-width">
                            <ul class="item-sub-cat">
                                ...
                                <div class="accordion-content collapse show">
                                    ...
                                    <li><a class="/email-preference-footer" href="/my-account/email-preferences/">Update Your Email
                                        Preferences</a></li>
                                    <li><a class="" href="/trade-in.html?transaction=trade&amp;referrer=footer">Trade-In Your Watch</a>
                                    </li>
                                    <li><a class="" href="/sell-us-your-rolex.html?transaction=sell&amp;referrer=footerRolex">Sell my
                                        Rolex</a></li>
                                    <li><a class="" href="/sell-us-your-watch.html?transaction=trade&amp;referrer=footer">Sell my
                                        Watch</a></li>
                                ...
                                <div class="accordion-content collapse show">
                                    <li><a href="/never-pay-retail.html" class="">About Jomashop</a></li>
                                    <li><a class="" href="/reviews.html">Jomashop Reviews</a></li>
                                    <li><a href="//www.jomashop.com/blog/" class="">The Parlor: Our Blog</a></li>
                                    <li><a href="https://jomashop.zendesk.com/hc/en-us/articles/11923106976027-Affiliate-Program/"
                                        class="">Affiliate Program</a></li>
                                    <li><a
                                        href="https://jomashop.zendesk.com/hc/en-us/articles/11923118279835-Are-your-watches-authentic-/"
                                        class="">Authenticity Guarantee</a></li>
                                    <li><a class="" href="/coupons-and-promocodes.html">Jomashop Coupon Codes</a></li>
                                    <li><a class="" href="/gift-card.html">Jomashop Gift Cards</a></li>
                                </div>
                                </div>
                                ...
                                <div class="accordion-content contain-non-links collapse show">
                                    ...
                                    <div class="chat-call chat"><span class="chat-icon-support"><svg width="26" height="26"
                                            ...
                                            fill="white"></path>
                                        </svg></span><span class="chat-text">Chat </span><strong class="chat-or">or </strong><span
                                        class="call-text">Call </span><span class="chat-call-phone-number">(877) 834-1434</span></div>
                                    <ul class="chat-call-dropdown">
                                        <li><a href="tel://1-877-834-1434" data-href="tel://1-877-834-1434"
                                            ...
                                            </svg><span class="dropdown-text">Call</span></a></li>
                                        <li><a href="#" title="Tap here to Live Chat"><svg width="24" height="24" viewBox="0 0 24 24"
                                            ...
                                            <path
                                                d="M17.875 12.5938C18.7725 12.5938 19.5 11.8662 19.5 10.9688C19.5 10.0713 18.7725 9.34375 17.875 9.34375C16.9775 9.34375 16.25 10.0713 16.25 10.9688C16.25 11.8662 16.9775 12.5938 17.875 12.5938Z"
                                                fill="black"></path>
                                            </svg><span class="dropdown-text">Chat</span></a></li>
                                        <li class="whatsapp-item"><a
                                            ...
                                            </svg><span class="dropdown-text">WhatsApp</span></a></li>
                                    </ul>
                                    </div>
                                    <div class="currency-converter accordion-item opened currency-desktop">
                                    <div class="accordion-head currency">Currency Converter</div>
                                    <ul class="accordion-content">
                                        <div class="currency-wrapper"><button class="currency-toggle"><img
                                            src="/dist/file/usd.0fb3ccd8c33808902bbd.svg" class="currency-icon" title="USD"
                                            alt="USD"><span class="button-label">USD</span><span class="button-symbol">$</span><svg
                                            xmlns="http://www.w3.org/2000/svg" width="9.605" height="5.492" viewBox="0 0 9.605 5.492"
                                            fill="currentColor">
                                            <path
                                                d="M10.992,15.083l3.632-3.635a.684.684,0,0,1,.969,0,.692.692,0,0,1,0,.972l-4.115,4.118a.685.685,0,0,1-.947.02L6.388,12.423a.687.687,0,1,1,.969-.972Z"
