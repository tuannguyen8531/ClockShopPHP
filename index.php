    ...
    <div class="multi-slideout-container">
        <div class="multi-slideout-header">
            <div class="slide-out-tabs open"><button
                    ...
                    class="slide-out-tab cart-tab"><span>Bag</span>(0)</button></div><button class="btn-close"><svg
                ...
                <div class="account-form-steps open">
                    ...
                    ">
                        ...
                        <form><button type="submit"
                                class="social-login social-login__google btn btn-primary btn-block btn-lg"><svg
                                    ...
                                    <path
                                        ...
                                        fill="#EA4335"></path>
                                </svg><span class="button-words">Sign in with Google</span></button><button
                                type="submit"
                                class="social-login social-login__apple btn btn-primary btn-block btn-lg"><svg
                                ...
                                </svg><span class="button-words">Sign in with Apple</span></button></form>
                        ...
                        <form method="post">
                            <div class="field-wrapper  can-focus  "><label for="email_address" class="label">Email<span
                                        class="requiredSymbol">*</span></label>
                                <div class="field-icons" style="--iconsBefore: 0; --iconsAfter: 0;"><span
                                        class="input-block"><input class="input-box-new-design" field="email"
                                            type="email" autocomplete="email" placeholder="Email" id="email_address" name="emailC"
                                            aria-required="true" value="">
                                        </span><span class="before"></span><span
                    ...
                    <div aria-labelledby="account-register-form-heading" class="account-register-form account-form-wrapper"
                        ...
                        <form method="post">
                            <div class="field-wrapper  can-focus   show-label is-focused"><label for="email_address"
