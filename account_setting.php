                    ...
                    <div class="myaccount-wrapper">
                        ...
                        <div class="myaccount-content">
                            <div>
                                ...
                                <h1 class="my-account__page-title">Account Settings</h1>
                                <form class="account-information " method="post">
                                    <div class="group-form">
                                        <div class="field-wrapper  can-focus  "><label for="firstname"
                                                class="label">First Name<span class="requiredSymbol">*</span></label>
                                            <div class="input-wrapper">
                                                <div class="field-icons" style="--iconsBefore: 0; --iconsAfter: 0;">
                                                    <span class="input-block"><input class="input-box-new-design"
                                                            field="firstname" type="text" id="firstname" disabled=""
                                                            value="<?= $customer['cusFirstName'] ?>"></span><span class="before"></span><span
                                                        class="after"></span></div><span class="message-root">
                                                    <p class="root"></p>
                                                </span><a title="Edit" class="link-input"
                                                    href="./change_info.php"><svg
                                        ...
                                        <div class="field-wrapper  can-focus  "><label for="lastname" class="label">Last
                                                Name<span class="requiredSymbol">*</span></label>
                                            <div class="field-icons" style="--iconsBefore: 0; --iconsAfter: 0;"><span
                                                    class="input-block"><input class="input-box-new-design"
                                                        field="lastname" type="text" id="lastname" name="lastname"
                                                        value="<?= $customer['cusLastName'] ?>"></span><span
                                                    class="before"></span><span class="after"></span></div><span
                                                class="message-root">
                                                <p class="root"></p>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="field-wrapper  can-focus  "><label for="Password"
                                            class="label">Password<span class="requiredSymbol">*</span></label>
                                        <div class="input-wrapper">
                                            <div class="field-icons" style="--iconsBefore: 0; --iconsAfter: 0;"><span
                                                    class="input-block"><input class="input-box-new-design"
                                                        field="password" type="text" id="password" disabled=""
                                                        placeholder="***********" value=""></span><span
                                                    class="before"></span><span class="after"></span></div><span
                                                class="message-root">
                                                <p class="root"></p>
                                            </span><a title="Change Password" class="link-input"
                                                href="./change_password.php"><svg
                                    ...
                                    <div class="field-wrapper  can-focus  "><label for="email" class="label">Email<span
                                                class="requiredSymbol">*</span></label>
                                        <div class="input-wrapper">
                                            <div class="field-icons" style="--iconsBefore: 0; --iconsAfter: 0;"><span
                                                    class="input-block"><input class="input-box-new-design"
                                                        field="email" type="email" id="email" disabled=""
                                                        value="<?= $customer['cusEmail'] ?>"></span><span
                                                    class="before"></span><span class="after"></span></div><span
                                                class="message-root">
                                                <p class="root"></p>
                                            </span><a title="Change Email" class="link-input"
                                                href="./change_email.php"><svg
                                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                                                    height="24">
                                                    <path
                                                        d="M5 18.89H6.41421L15.7279 9.57629L14.3137 8.16207L5 17.4758V18.89ZM21 20.89H3V16.6474L16.435 3.21233C16.8256 2.8218 17.4587 2.8218 17.8492 3.21233L20.6777 6.04075C21.0682 6.43128 21.0682 7.06444 20.6777 7.45497L9.24264 18.89H21V20.89ZM15.7279 6.74786L17.1421 8.16207L18.5563 6.74786L17.1421 5.33365L15.7279 6.74786Z">
                                    ...
                                    <div class="account-actions">
                                        <button class="btn-new-design primary" type="submit" name="save">Save Changes</button>
                                    </div>
                                </form>
                            </div>
                        </div>
